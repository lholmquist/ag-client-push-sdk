...
-(void)registerWithClientInfo:(void (^)(id<AGClientDeviceInformation>))clientInfo success:(void (^)(id))success failure:(void (^)(NSError *))failure {
    ...
    // add the variant ID:
    [_client setDefaultHeader:@"ag-push-app" value:clientInfoObject.mobileVariantID];
    [_client setDefaultHeader:@"ag-mobile-app" value:clientInfoObject.mobileVariantInstanceID];
